...
@section('content')
    ...
    <link rel="stylesheet" href="{{ asset('CSS/genderwinterdesign.css') }}">
    ...
    <div class="winter-selection-wrapper">
        <div class="selection-header">
            ...
            <p>Find the perfect scent for snowy days and chill nights.</p>
        </div>

        <div class="gender-options-container">
            <!-- MEN -->
            <a href="{{ route('winter.index', ['gender' => 'men']) }}" class="option-card">
                <div class="image-box">
                    <img src="{{ asset('images/malewinter.jpg') }}" alt="Male">
                </div>
                <div class="card-info">
                    <h2>FOR HIM</h2>
            ...
            <!-- WOMEN -->
            <a href="{{ route('winter.index', ['gender' => 'women']) }}" class="option-card">
                <div class="image-box">
                    <img src="{{ asset('images/femalewinter.jpg') }}" alt="Women">
                </div>
                <div class="card-info">
                    <h2>FOR HER</h2>
                    <span class="btn-discover">Discover &rarr;</span>
