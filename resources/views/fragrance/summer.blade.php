            ...
            <div class="filter-bar">
                <form action="{{ url()->current() }}" method="GET" id="filterForm">
                    <select name="brand" onchange="this.form.submit()">
                        ...
                        <option value="AquaVibe" {{ request('brand') == 'AquaVibe' ? 'selected' : '' }}>AquaVibe</option>
                        <option value="Coastal" {{ request('brand') == 'Coastal' ? 'selected' : '' }}>Coastal</option>
                        <option value="Luxe" {{ request('brand') == 'Luxe' ? 'selected' : '' }}>Luxe</option>
                        <option value="Botanica" {{ request('brand') == 'Botanica' ? 'selected' : '' }}>Botanica</option>
                    </select>
